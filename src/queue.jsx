...
function schedulerUserRole(user, t) {
  ...
  const labels = [];
  if (roles.includes('pd')) labels.push(t('postDesigner'));
  ...
  return labels.join(' · ') || t('notQueueParticipant');
}
