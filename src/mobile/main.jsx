...
function DashboardView({ viewer }) {
  const [separateTopics, setSeparateTopics] = useState([]); const [count, setCount] = useState(60);
  const { t } = usePrefs();
  ...
  const { groups: topics, loading: grouping } = useTopicGroups(filtered, true, separateTopics);
