...
const tracker = { tracking_since: day, accounts: [{ handle: 'chatgptricks', label: 'ChatGPTricks', followers: 100000, delta_7d: { delta: 1200 }, avg_likes_30d: 2200 }] };
...
(async () => {
  ...
  try {
    ...
    await click(nav[3]);
    checks['Independent Tracker renders'] = document.querySelectorAll('.m-account-list > button').length === 1;
    await click(nav[4]);
