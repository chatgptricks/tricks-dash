...
const dom = new JSDOM('<!doctype html><html><head><title>Settings</title></head><body><div id="root"></div></body></html>', { url: 'https://sentientdash.app/settings.html', pretendToBeVisual: true });
...
const build = await esbuild.build({
  entryPoints: ['smoke/settings-entry.jsx'], bundle: true, write: false, format: 'esm', platform: 'browser', jsx: 'automatic', target: 'es2022',
